...
--activité manuelle
INSERT INTO activity (title, description, image, tutorial, recommendedAge, category_id) VALUES ('Pâte à sel', 'La pâte à sel est une pâte à modeler qui durcit à l''air libre. Elle est composée de farine, de sel et d''eau. Elle est très facile à réaliser et permet de réaliser de nombreuses créations.', 'static/assets/images/pate_a_sel.png', 'La pâte à sel est une activité artistique de modelage très facile à mettre en œuvre. Elle est réalisée à partir de farine, de sel et d''eau. Une fois les objets modelés selon l'imagination, il faut les faire sécher à l'air libre pendant plusieurs jours ou au four pendant quelques dizaines de minutes, en fonction de la taille des créations.', 6, 1);
INSERT INTO activity (title, description, image, tutorial, recommendedAge, category_id) VALUES ('Peinture sur galets', 'La peinture sur galets est une activité artistique amusante qui permet de créer de jolis objets décoratifs. Les galets peuvent être transformés en animaux, en motifs abstraits ou en personnages colorés.', 'static/assets/images/peinture_sur_galets.png', 'La peinture sur galets est une activité créative qui consiste à peindre des galets avec des motifs et des couleurs variés. Les enfants peuvent laisser libre cours à leur imagination pour créer des œuvres uniques. Après la peinture, les galets peuvent être disposés dans le jardin ou utilisés comme décorations intérieures.', 5, 1);
INSERT INTO activity (title, description, image, tutorial, recommendedAge, category_id) VALUES ('Constructions en carton', 'Les constructions en carton sont une activité créative qui permet aux enfants de donner libre cours à leur imagination en utilisant des matériaux recyclés. Les boîtes, les tubes et les emballages peuvent être transformés en maisons, en voitures, en robots et bien plus encore.', 'static/assets/images/constructions_en_carton.png', 'Les constructions en carton sont une activité manuelle ludique qui encourage les enfants à réutiliser des matériaux recyclés pour créer des objets uniques. Les boîtes, les tubes et les emballages peuvent être découpés, assemblés et décorés pour donner vie à des maisons, des châteaux, des vaisseaux spatiaux et bien d'autres créations imaginatives.', 7, 1);
INSERT INTO activity (title, description, image, tutorial, recommendedAge, category_id) VALUES ('Fabrication de marionnettes', 'La fabrication de marionnettes est une activité artistique et ludique qui permet aux enfants de créer leurs propres personnages en tissu ou en papier. Les marionnettes peuvent être utilisées pour inventer des histoires et jouer des spectacles.', 'static/assets/images/marionnettes.png', 'La fabrication de marionnettes est une activité manuelle qui encourage la créativité des enfants. En utilisant du tissu, du papier, des boutons et d'autres matériaux, les enfants peuvent concevoir et fabriquer leurs propres marionnettes. Ils peuvent ensuite les utiliser pour inventer des histoires et jouer des spectacles, ce qui stimule leur imagination et leur expression artistique.', 6, 1);


--plein air
INSERT INTO activity (title, description, image, tutorial, recommendedAge, category_id) VALUES ('Chasse au trésor', 'La chasse au trésor nature est une aventure passionnante qui invite les enfants à explorer l''environnement extérieur tout en s''amusant...', 'static/assets/images/chasse_au_tresor.png', 'Préparation des indices : Avant l''activité, prépare des indices qui guideront les enfants... ', 4, 2);
